		...
		if (this.hasPeerId()) {
			try{
				if(this.hexPeerId == null){
					this.hexPeerId = Torrent.byteArrayToHexString(this.peerId.array());
					System.err.println("3:" + this.hexPeerId);
				}
				s.append(this.hexPeerId.substring(this.hexPeerId.length()-6));
			} catch(NullPointerException ex) {
				System.err.println("-1:" + s.toString());
				System.err.println("0:" + this.peerId.toString());
				System.err.println("1:" + this.hexPeerId);
				System.err.println("2:" + (this.hexPeerId.length() + ":" + this.hexPeerId.substring(this.hexPeerId.length()-6)));
				System.err.println("Caught NullPointerException: " + ex.getMessage());
			}
